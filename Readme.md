...
Литература:
1. Смарт Н. "Криптография" 2005 - 528с.
2. Вендо Мао "Современная криптография" 2002 - 728с.
3. XF "Основы Криптологии" 2006 - 571с
4. Саломаа А. "Криптография с открытым ключем" 1995 - 768с.
5. Каутинхо С. "Введение в теорию числе, алгоритмы RSA" 2001 - 368c.

Модель симметричної криптосистеми
І. Криптографія і ії основні пункти
ІІ. Модель Шеннона криптографічної системи
ІІІ. Принцип Керкхоффса

Фізична оцінка верхньої границі ключа
